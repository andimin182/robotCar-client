...
: ${AMENT_CURRENT_PREFIX:="/root/dev_ws/install/custom_control_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_control_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_control_pkg/environment/path.sh"

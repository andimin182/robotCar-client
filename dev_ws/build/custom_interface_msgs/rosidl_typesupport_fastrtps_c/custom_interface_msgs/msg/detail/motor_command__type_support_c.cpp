...
#include "custom_interface_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommand__ros_msg_type = custom_interface_msgs__msg__MotorCommand;
...
size_t get_serialized_size_custom_interface_msgs__msg__MotorCommand(
  const void * untyped_ros_message,
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface_msgs__msg__MotorCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interface_msgs
size_t max_serialized_size_custom_interface_msgs__msg__MotorCommand(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_interface_msgs__msg__MotorCommand(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interface_msgs, msg, MotorCommand)() {

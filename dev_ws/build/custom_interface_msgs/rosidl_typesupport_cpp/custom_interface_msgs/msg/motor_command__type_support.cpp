...
static const _MotorCommand_type_support_symbol_names_t _MotorCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface_msgs, msg, MotorCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface_msgs, msg, MotorCommand)),
  }
};
...
get_message_type_support_handle<custom_interface_msgs::msg::MotorCommand>()
{
  return &::custom_interface_msgs::msg::rosidl_typesupport_cpp::MotorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interface_msgs, msg, MotorCommand)() {
  return get_message_type_support_handle<custom_interface_msgs::msg::MotorCommand>();
}

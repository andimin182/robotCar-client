...
static const _ServoCameraCommand_type_support_symbol_names_t _ServoCameraCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interface_msgs, msg, ServoCameraCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interface_msgs, msg, ServoCameraCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interface_msgs, msg, ServoCameraCommand)() {
  return &::custom_interface_msgs::msg::rosidl_typesupport_c::ServoCameraCommand_message_type_support_handle;
}

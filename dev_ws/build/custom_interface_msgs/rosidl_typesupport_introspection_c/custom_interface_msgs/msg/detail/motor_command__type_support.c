...
#include <stddef.h>
#include "custom_interface_msgs/msg/detail/motor_command__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interface_msgs__msg__MotorCommand__init(message_memory);
}

void MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_fini_function(void * message_memory)
{
  custom_interface_msgs__msg__MotorCommand__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_message_member_array[1] = {
  {
    "command",  // name
    ...
    offsetof(custom_interface_msgs__msg__MotorCommand, command),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interface_msgs__msg__MotorCommand),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interface_msgs, msg, MotorCommand)() {
